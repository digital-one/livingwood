<?php
//
// Testimonial Post Type related functions.
//
...
function cpt_testimonial_taxonomies() {
	...
	//
	$labels = array(
		'name' => _x( 'Testimonial Categories', 'taxonomy general name', 'dc_theme' ),
		'singular_name' => _x( 'Testimonial Category', 'taxonomy singular name', 'dc_theme' ),
		'search_items' =>  __( 'Search Testimonial Categories', 'dc_theme' ),
		'all_items' => __( 'All Testimonial Categories', 'dc_theme' ),
		'parent_item' => __( 'Parent Testimonial Categories', 'dc_theme' ),
		'parent_item_colon' => __( 'Parent Testimonial Categories:', 'dc_theme' ),
		'edit_item' => __( 'Edit Testimonial Category', 'dc_theme' ), 
		'update_item' => __( 'Update Testimonial Category', 'dc_theme' ),
		'add_new_item' => __( 'Add Testimonial Category', 'dc_theme' ),
...
add_rewrite_rule('^news-testimonials/testimonials/archive/yr/([^/]*)/?', 'index.php?pagename=news-testimonials/testimonials&yr=$matches[1]','top');
